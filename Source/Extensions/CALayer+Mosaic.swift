...
extension CALayer {
    ...
    func attachMosaic(type: MosaicType) {
        ...
        let isValidityScale = absoluteScale > 0 && !absoluteScale.isNaN && !absoluteScale.isInfinite
        rasterizationScale = isValidityScale ? absoluteScale : type.rasterizationScale
